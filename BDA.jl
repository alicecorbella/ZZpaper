...
plot(plot(t -> rateswitchj(t; j=2, x0=[-0.5, 9, -0.5], v0=[1,1,1])[1], 0,5),
    plot(t -> rateswitchj(t; j=2, x0=[-0.5, 9, -0.5], v0=[1,1,1])[2], 0,5),
    plot(t -> rateswitchj(t; j=2, x0=[-0.5, 9, -0.5], v0=[1,1,1])[3], 0,5), layout=(3,1))
